...
class modarronditotal extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->picto='arronditotal.svg@arronditotal';


		// Url to the file with your last numberversion of this module
		require_once __DIR__ . '/../../class/techatm.class.php';
		$this->url_last_version = \arronditotal\TechATM::getLastModuleVersionUrl($this);
		...
		//							'workflow' => array('WORKFLOW_MODULE1_YOURACTIONTYPE_MODULE2'=>array('enabled'=>'isModEnabled("module1") && isModEnabled("module2")', 'picto'=>'yourpicto@arronditotal')) // Set here all workflow context managed by module
		//                        );
		$this->module_parts = array(
        ...
        /* Example:
        if (! isModEnabled("arronditotal")) $conf->arronditotal->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            ...
            'tabcond'=>array(isModEnabled("arronditotal"),isModEnabled("arronditotal"),isModEnabled("arronditotal"))												// Condition to show each dictionary
        );
        */
		...
		//							'position'=>100,
		//							'enabled'=>'isModEnabled("arronditotal")',	// Define condition to show or hide menu entry. Use 'isModEnabled("arronditotal")' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->hasRight("arronditotal", "level1", "level2")' if you want your menu with a permission rules
		//							'target'=>'',
